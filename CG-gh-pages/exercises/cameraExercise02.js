...
function keyboardUpdate() {
   ...
   if (keyboard.pressed("space")) cameraHolder.translateZ(-speed);
   if (keyboard.pressed("B")) cameraHolder.translateZ(speed);
   if (keyboard.pressed("A")) cameraHolder.translateX(-speed);
   if (keyboard.pressed("D")) cameraHolder.translateX(speed);
   if (keyboard.pressed("W")) cameraHolder.translateY(speed);
   if (keyboard.pressed("S")) cameraHolder.translateY(-speed);
