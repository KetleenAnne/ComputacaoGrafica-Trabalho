...
function keyboardUpdate() {
   ...
   if (keyboard.down("left")) camPos.x -= 1.0;
   if (keyboard.down("right")) camPos.x += 1.0;
   if (keyboard.down("up")) camPos.y += 1.0;
   if (keyboard.down("down")) camPos.y -= 1.0;
   if (keyboard.down("pageup")) camPos.z -= 1.0;
   if (keyboard.down("pagedown")) camPos.z += 1.0;

   if (keyboard.down("A")) camLook.x -= 1.0;
   if (keyboard.down("D")) camLook.x += 1.0;
   if (keyboard.down("W")) camLook.y += 1.0;
   if (keyboard.down("S")) camLook.y -= 1.0;
   if (keyboard.down("Q")) camLook.z -= 1.0;
   if (keyboard.down("E")) camLook.z += 1.0;
