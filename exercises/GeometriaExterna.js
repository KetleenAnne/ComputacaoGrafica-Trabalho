...
let assetManager = {
   ...
   checkLoaded : function() {
      if(!this.allLoaded)
      {
         if(this.dolphins && this.vase && this.flowers && 
            this.f16 && this.soccerball && this.toucan && this.cow && this.tankimp){
             this.allLoaded = true;
             loadingMessage.hide(); 
         }
      }
   ...
   hideAll : function() {
      ...
      this.cow.visible= this.tankimp.visible = false;
   }
}
...
loadGLBFile('../assets/objects/', 'tankimp', false, 1.0);
...
function buildInterface()
{
  ...
  gui.add(controls, 'type',
    ['dolphins', 'vase', 'flowers', 'f16', 'soccerball', 'toucan', 'cow', 'tankimp'])
    .name("Change Object")
